...
public class UpdateTeacherTraitsTask extends TimerTask {
    ...
    @Autowired
    public UpdateTeacherTraitsTask(TeacherService teacherService) {
    ...
    public void run() {
        //            runPythonModule();
        System.out.println(teacherService.findAll().size());
    }
    ...
    private void runPythonModule() throws IOException, InterruptedException {
